...
(function($) {
  ...
  $(function() {
    ...
    // Custom Selects
    $("select[name='pgorder']").selectpicker({style: 'btn-primary', menuStyle: 'dropdown-inverse'});
	$("select[name='sub']").selectpicker({style: 'btn-primary', menuStyle: 'dropdown-inverse'});
