<?php
$docRoot = str_replace('/', '\\', $_SERVER['DOCUMENT_ROOT'].'\includes\functions.php');
//include files if not already included
if(!in_array($docRoot, get_included_files())){
...
if(isset($_GET['blogid'])){
	...
	if($limiter!=false){
		//Get limited number of sorted comments
